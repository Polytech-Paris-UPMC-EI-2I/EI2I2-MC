...
int main()
	{
	  ...
	  while (1) //Boucle infinie
	  {
	    ...
	    */
	  	...
	  	/* test de la fonction de transmission */
	  	// transmettre le caractere traiter
	  	// ecrire le code a la ligne ci-dessous
...
/*----------------------------------------------------------------------------
  UART_Write_Char_User
  @brief  : Envoi d'un charactère vers le PC
  @param  : CaractereAenvoyer caractere a envoyer: ex: 'e'
  @retval : rien
  effets de bords : 
 *----------------------------------------------------------------------------*/
void UART_Write_Char_User (unsigned char CaractereAenvoyer)
 {        
...
/*----------------------------------------------------------------------------
   UART_Read_Char_User (void)
  @brief  : Envoi d'un charactère vers le PC
  @param  : rien
  @retval : Caractere recu
  effets de bords : 
 *----------------------------------------------------------------------------*/
 unsigned char UART_Read_Char_User (void)
 {
